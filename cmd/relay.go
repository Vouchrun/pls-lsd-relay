...
func startRelayCmd() *cobra.Command {
  ...
  endpoints: %v`,
				...
				cfg.BatchRequestBlocksNumber, cfg.EventFilterMaxSpanBlocks, cfg.MaxEjectedValPerCycle, cfg.MaxGasPrice, cfg.GasPriceMultiplier, cfg.Endpoints)
