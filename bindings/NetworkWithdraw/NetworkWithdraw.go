...
func (_NetworkWithdraw *NetworkWithdrawTransactor) SetMerkleRoot(opts *bind.TransactOpts, _dealedEpoch *big.Int, _merkleRoot [32]byte) (*types.Transaction, error) {
	return _NetworkWithdraw.contract.Transact(opts, "setMerkleRoot", _dealedEpoch, _merkleRoot)
}

// SetMerkleRoot is a paid mutator transaction binding the contract method 0x18712c21.
//
// Solidity: function setMerkleRoot(uint256 _dealedEpoch, bytes32 _merkleRoot) returns()
func (_NetworkWithdraw *NetworkWithdrawSession) SetMerkleRoot(_dealedEpoch *big.Int, _merkleRoot [32]byte) (*types.Transaction, error) {
	return _NetworkWithdraw.Contract.SetMerkleRoot(&_NetworkWithdraw.TransactOpts, _dealedEpoch, _merkleRoot)
}

// SetMerkleRoot is a paid mutator transaction binding the contract method 0x18712c21.
//
// Solidity: function setMerkleRoot(uint256 _dealedEpoch, bytes32 _merkleRoot) returns()
func (_NetworkWithdraw *NetworkWithdrawTransactorSession) SetMerkleRoot(_dealedEpoch *big.Int, _merkleRoot [32]byte) (*types.Transaction, error) {
	return _NetworkWithdraw.Contract.SetMerkleRoot(&_NetworkWithdraw.TransactOpts, _dealedEpoch, _merkleRoot)
}
