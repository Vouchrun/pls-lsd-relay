...
// MerkleTreeCid is a free data retrieval call binding the contract method 0x1736ce44.
//
// Solidity: function merkleTreeCid() view returns(string)
func (_NetworkWithdraw *NetworkWithdrawCaller) MerkleTreeCid(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _NetworkWithdraw.contract.Call(opts, &out, "merkleTreeCid")
...
//
// Solidity: function merkleTreeCid() view returns(string)
func (_NetworkWithdraw *NetworkWithdrawSession) MerkleTreeCid() (string, error) {
	return _NetworkWithdraw.Contract.MerkleTreeCid(&_NetworkWithdraw.CallOpts)
}

// MerkleTreeCid is a free data retrieval call binding the contract method 0x1736ce44.
//
// Solidity: function merkleTreeCid() view returns(string)
func (_NetworkWithdraw *NetworkWithdrawCallerSession) MerkleTreeCid() (string, error) {
	return _NetworkWithdraw.Contract.MerkleTreeCid(&_NetworkWithdraw.CallOpts)
}
...
//
// Solidity: function setMerkleRoot(uint256 _dealedEpoch, bytes32 _merkleRoot, string _merkleTreeCid) returns()
func (_NetworkWithdraw *NetworkWithdrawTransactor) SetMerkleRoot(opts *bind.TransactOpts, _dealedEpoch *big.Int, _merkleRoot [32]byte, _merkleTreeCid string) (*types.Transaction, error) {
	return _NetworkWithdraw.contract.Transact(opts, "setMerkleRoot", _dealedEpoch, _merkleRoot, _merkleTreeCid)
}

// SetMerkleRoot is a paid mutator transaction binding the contract method 0x12b81931.
//
// Solidity: function setMerkleRoot(uint256 _dealedEpoch, bytes32 _merkleRoot, string _merkleTreeCid) returns()
func (_NetworkWithdraw *NetworkWithdrawSession) SetMerkleRoot(_dealedEpoch *big.Int, _merkleRoot [32]byte, _merkleTreeCid string) (*types.Transaction, error) {
	return _NetworkWithdraw.Contract.SetMerkleRoot(&_NetworkWithdraw.TransactOpts, _dealedEpoch, _merkleRoot, _merkleTreeCid)
}

// SetMerkleRoot is a paid mutator transaction binding the contract method 0x12b81931.
//
// Solidity: function setMerkleRoot(uint256 _dealedEpoch, bytes32 _merkleRoot, string _merkleTreeCid) returns()
func (_NetworkWithdraw *NetworkWithdrawTransactorSession) SetMerkleRoot(_dealedEpoch *big.Int, _merkleRoot [32]byte, _merkleTreeCid string) (*types.Transaction, error) {
	return _NetworkWithdraw.Contract.SetMerkleRoot(&_NetworkWithdraw.TransactOpts, _dealedEpoch, _merkleRoot, _merkleTreeCid)
}
...
//
// Solidity: event SetMerkleRoot(uint256 _dealedEpoch, bytes32 _merkleRoot, string _merkleTreeCid)
func (_NetworkWithdraw *NetworkWithdrawFilterer) FilterSetMerkleRoot(opts *bind.FilterOpts) (*NetworkWithdrawSetMerkleRootIterator, error) {

	logs, sub, err := _NetworkWithdraw.contract.FilterLogs(opts, "SetMerkleRoot")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event SetMerkleRoot(uint256 _dealedEpoch, bytes32 _merkleRoot, string _merkleTreeCid)
func (_NetworkWithdraw *NetworkWithdrawFilterer) WatchSetMerkleRoot(opts *bind.WatchOpts, sink chan<- *NetworkWithdrawSetMerkleRoot) (event.Subscription, error) {

	logs, sub, err := _NetworkWithdraw.contract.WatchLogs(opts, "SetMerkleRoot")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
