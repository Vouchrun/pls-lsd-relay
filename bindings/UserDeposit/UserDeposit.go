...
// NetworkWithdrawalAddress is a free data retrieval call binding the contract method 0xa12e9825.
//
// Solidity: function networkWithdrawalAddress() view returns(address)
func (_UserDeposit *UserDepositCaller) NetworkWithdrawalAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _UserDeposit.contract.Call(opts, &out, "networkWithdrawalAddress")
...
//
// Solidity: function networkWithdrawalAddress() view returns(address)
func (_UserDeposit *UserDepositSession) NetworkWithdrawalAddress() (common.Address, error) {
	return _UserDeposit.Contract.NetworkWithdrawalAddress(&_UserDeposit.CallOpts)
}

// NetworkWithdrawalAddress is a free data retrieval call binding the contract method 0xa12e9825.
//
// Solidity: function networkWithdrawalAddress() view returns(address)
func (_UserDeposit *UserDepositCallerSession) NetworkWithdrawalAddress() (common.Address, error) {
	return _UserDeposit.Contract.NetworkWithdrawalAddress(&_UserDeposit.CallOpts)
}
...
// RecycleNetworkWithdrawalDeposit is a paid mutator transaction binding the contract method 0xaf22888f.
//
// Solidity: function recycleNetworkWithdrawalDeposit() payable returns()
func (_UserDeposit *UserDepositTransactor) RecycleNetworkWithdrawalDeposit(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _UserDeposit.contract.Transact(opts, "recycleNetworkWithdrawalDeposit")
}

// RecycleNetworkWithdrawalDeposit is a paid mutator transaction binding the contract method 0xaf22888f.
//
// Solidity: function recycleNetworkWithdrawalDeposit() payable returns()
func (_UserDeposit *UserDepositSession) RecycleNetworkWithdrawalDeposit() (*types.Transaction, error) {
	return _UserDeposit.Contract.RecycleNetworkWithdrawalDeposit(&_UserDeposit.TransactOpts)
}

// RecycleNetworkWithdrawalDeposit is a paid mutator transaction binding the contract method 0xaf22888f.
//
// Solidity: function recycleNetworkWithdrawalDeposit() payable returns()
func (_UserDeposit *UserDepositTransactorSession) RecycleNetworkWithdrawalDeposit() (*types.Transaction, error) {
	return _UserDeposit.Contract.RecycleNetworkWithdrawalDeposit(&_UserDeposit.TransactOpts)
}
