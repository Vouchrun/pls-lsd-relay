...
func (_NodeDeposit *NodeDepositTransactor) OffBoard(opts *bind.TransactOpts, _validatorPubkey []byte) (*types.Transaction, error) {
	return _NodeDeposit.contract.Transact(opts, "offBoard", _validatorPubkey)
}

// OffBoard is a paid mutator transaction binding the contract method 0x84d9eb7c.
//
// Solidity: function offBoard(bytes _validatorPubkey) returns()
func (_NodeDeposit *NodeDepositSession) OffBoard(_validatorPubkey []byte) (*types.Transaction, error) {
	return _NodeDeposit.Contract.OffBoard(&_NodeDeposit.TransactOpts, _validatorPubkey)
}

// OffBoard is a paid mutator transaction binding the contract method 0x84d9eb7c.
//
// Solidity: function offBoard(bytes _validatorPubkey) returns()
func (_NodeDeposit *NodeDepositTransactorSession) OffBoard(_validatorPubkey []byte) (*types.Transaction, error) {
	return _NodeDeposit.Contract.OffBoard(&_NodeDeposit.TransactOpts, _validatorPubkey)
}
...
func (_NodeDeposit *NodeDepositTransactor) ProvideNodeDepositToken(opts *bind.TransactOpts, _validatorPubkey []byte) (*types.Transaction, error) {
	return _NodeDeposit.contract.Transact(opts, "provideNodeDepositToken", _validatorPubkey)
}

// ProvideNodeDepositToken is a paid mutator transaction binding the contract method 0xeee1fa44.
//
// Solidity: function provideNodeDepositToken(bytes _validatorPubkey) payable returns()
func (_NodeDeposit *NodeDepositSession) ProvideNodeDepositToken(_validatorPubkey []byte) (*types.Transaction, error) {
	return _NodeDeposit.Contract.ProvideNodeDepositToken(&_NodeDeposit.TransactOpts, _validatorPubkey)
}

// ProvideNodeDepositToken is a paid mutator transaction binding the contract method 0xeee1fa44.
//
// Solidity: function provideNodeDepositToken(bytes _validatorPubkey) payable returns()
func (_NodeDeposit *NodeDepositTransactorSession) ProvideNodeDepositToken(_validatorPubkey []byte) (*types.Transaction, error) {
	return _NodeDeposit.Contract.ProvideNodeDepositToken(&_NodeDeposit.TransactOpts, _validatorPubkey)
}
...
func (_NodeDeposit *NodeDepositTransactor) WithdrawNodeDepositToken(opts *bind.TransactOpts, _validatorPubkey []byte) (*types.Transaction, error) {
	return _NodeDeposit.contract.Transact(opts, "withdrawNodeDepositToken", _validatorPubkey)
}

// WithdrawNodeDepositToken is a paid mutator transaction binding the contract method 0x3c4bc635.
//
// Solidity: function withdrawNodeDepositToken(bytes _validatorPubkey) returns()
func (_NodeDeposit *NodeDepositSession) WithdrawNodeDepositToken(_validatorPubkey []byte) (*types.Transaction, error) {
	return _NodeDeposit.Contract.WithdrawNodeDepositToken(&_NodeDeposit.TransactOpts, _validatorPubkey)
}

// WithdrawNodeDepositToken is a paid mutator transaction binding the contract method 0x3c4bc635.
//
// Solidity: function withdrawNodeDepositToken(bytes _validatorPubkey) returns()
func (_NodeDeposit *NodeDepositTransactorSession) WithdrawNodeDepositToken(_validatorPubkey []byte) (*types.Transaction, error) {
	return _NodeDeposit.Contract.WithdrawNodeDepositToken(&_NodeDeposit.TransactOpts, _validatorPubkey)
}
