...
//
// Solidity: function withdrawalCredentials() view returns(bytes)
func (_NodeDeposit *NodeDepositCaller) WithdrawalCredentials(opts *bind.CallOpts) ([]byte, error) {
	var out []interface{}
	err := _NodeDeposit.contract.Call(opts, &out, "withdrawalCredentials")
...
//
// Solidity: function withdrawalCredentials() view returns(bytes)
func (_NodeDeposit *NodeDepositSession) WithdrawalCredentials() ([]byte, error) {
	return _NodeDeposit.Contract.WithdrawalCredentials(&_NodeDeposit.CallOpts)
}

// WithdrawalCredentials is a free data retrieval call binding the contract method 0x4cd79e0a.
//
// Solidity: function withdrawalCredentials() view returns(bytes)
func (_NodeDeposit *NodeDepositCallerSession) WithdrawalCredentials() ([]byte, error) {
	return _NodeDeposit.Contract.WithdrawalCredentials(&_NodeDeposit.CallOpts)
}
