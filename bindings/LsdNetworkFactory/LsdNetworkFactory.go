...
type ILsdNetworkFactoryNetworkContracts struct {
	...
	NetworkWithdrawal common.Address
	Block             *big.Int
}
...
//
// Solidity: function networkContractsOfLsdToken(address ) view returns(address _feePool, address _networkBalances, address _networkProposal, address _nodeDeposit, address _userDeposit, address _networkWithdrawal, uint256 _block)
func (_LsdNetworkFactory *LsdNetworkFactoryCaller) NetworkContractsOfLsdToken(opts *bind.CallOpts, arg0 common.Address) (struct {
	...
	outstruct.NetworkWithdrawal = *abi.ConvertType(out[5], new(common.Address)).(*common.Address)
